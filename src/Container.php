...
use ArtPetrov\Selectel\CloudStorage\Traits\MetaData;
use ArtPetrov\Selectel\CloudStorage\Contracts\HasMetaData;
...
class Container implements ContainerContract, FilesTransformerContract, Countable, JsonSerializable, HasMetaData
{
    ...
    /**
     * @var \ArtPetrov\Selectel\CloudStorage\Contracts\Api\ApiClientContract $api
     */
    protected $api;
     ...
     * File uploader.
     *
     * @var \ArtPetrov\Selectel\CloudStorage\Contracts\FileUploaderContract
     */
    protected $uploader;
     ...
     * @param \ArtPetrov\Selectel\CloudStorage\FileUploader                    $uploader
     * @param string                                                               $name
     * @param array                                                                $data
     */
